 ...
 * Source https://github.com/Redman1037/EightFoldsDatePickerDialog
 */

public class MyCalendar extends DatePickerDialog {
    ...
    @RequiresApi(api = Build.VERSION_CODES.N)
    public MyCalendar(@NonNull Context context, int themeResId) {
        super(context, themeResId);
        datePickerDialog = new DatePickerDialog(context, themeResId);
    }

    public MyCalendar(@NonNull Context context, @Nullable OnDateSetListener listener, int year, int month, int dayOfMonth) {
        super(context, listener, year, month, dayOfMonth);
        datePickerDialog = new DatePickerDialog(context, listener, year, month, dayOfMonth);

    }

    public MyCalendar(@NonNull Context context, int themeResId, @Nullable OnDateSetListener listener, int year, int monthOfYear, int dayOfMonth) {
